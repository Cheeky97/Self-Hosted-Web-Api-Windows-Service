...
The Self-Hosted-Web-Api-Windows-Service/UserManagement_Service/ is a Windows Service project which is also created under the above console application and a reference has been added.
...
3. Now Go to the UserManagement_Service project source folder > bin > Debug and copy the full path of your Windows Service exe file.
